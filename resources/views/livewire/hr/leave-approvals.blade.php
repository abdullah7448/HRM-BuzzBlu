<div class="bg-white border border-gray-200 shadow-sm rounded-lg overflow-hidden mb-6">
    <div class="px-6 py-4 border-b border-gray-200 bg-blue-50 flex justify-between items-center">
        <h3 class="text-lg font-medium text-blue-900">Final Leave Approvals (HR Review)</h3>
    </div>
                ...
                @forelse($pendingRequests as $leave)
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-sm text-gray-500">{{ $leave->user->department->name ?? 'N/A' }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                            No pending leave requests awaiting HR review.
                        </td>
                    </tr>
                @endforelse
            </tbody>
