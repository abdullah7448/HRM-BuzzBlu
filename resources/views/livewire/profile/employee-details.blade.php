...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="flex justify-end space-x-3 mb-4">
            <!-- Show 'Edit Personal Info' & 'Change Password' ONLY if the user is viewing their OWN profile -->
            @if(Auth::id() === $user->id)
                <button wire:click="openPersonalModal" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 text-sm font-semibold rounded-md shadow-sm hover:bg-gray-50 transition">
                    Edit My Info
                </button>
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto bg-gray-500 bg-opacity-75 flex items-center justify-center">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Edit Personal Information</h3>
                <form wire:submit.prevent="updatePersonalInfo">
                    ...
                    <div class="flex justify-end space-x-3">
                        <button type="button" wire:click="closePersonalModal" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">Cancel</button>
                        <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Save Changes</button>
                    </div>
                </form>
            </div>
